...
RUN curl -o pdfix_sdk-8.6.0.tar.gz.zip -L https://github.com/pdfix/pdfix_sdk_builds/releases/download/v8.6.0-beta-5/python-pdfix_sdk-8.6.0_2d494dc2.tar.gz.zip ; \
